<img src="/assets/images/readme-banner.png" alt="The Freedom Project | An Irish Vanlife Blog">

# The Freedom Project | An Irish Vanlife Blog
### User-Centric Frontend Development Milestone Project - Code Institute

## **ABOUT**
The Freedom Project is an Irish vanlife blog detailing my own DIY camper conversion experience and tips for full-time vanlife in Ireland. The initial release contains a home page, an about page, a contact page, a blog with two categories, DIY Camper Conversion and Vanlife in Ireland (Coming Soon). The site features a single article, 5 Steps To Get Your Van On The Road, a clear step by step guide to getting a converted van on the road in Ireland.
...
### **Structure**
---
The blog will initially consist of six pages, a home page, an about page, a contact page, two article category pages, and an article page. Each page will feature a responsive nav bar and a footer.
- Home Page
    - Large hero image and heading.
    - Bio section with image and text.
    - Featured and recent article section.
    - Subscription sign up box.
- About Page
    - Profile image.
    - Body of text.
- Contact Page
    - Image banner with overlayed page heading.
    - Contact form.
- Article Category Pages
    - Image banner with overlayed page heading.
    - Vertical list of articles in the form of article cards.
- Article Page
    - Image banner with overlayed catagory heading.
    - Article body.
...
---
#### **Imagery:**
All the images used will come from my own personal library.

#### **Colors:**
![Color Palette](/assets/images/color-palette.PNG)

Color scheme was created with the aid of [Coolors.co](https://coolors.co/).
...
Each page, except Our Story, has a hero image and heading at the top of the screen. Each image is a photo I have taken during my days in the van. This is to help users build a better connection with the story and the content, it provides consistency across the site, and is visually appealing.

### **Home:**
The home page features a large hero-image and heading, allowing users to immediately identify the website's purpose. Below the hero image, there is an about section featuring a profile image and a short bio. This details who I am and what the blog is about, helping to create a connection with the user early on in their journey. Following this, there are three article cards, one for a featured article and one for a recent article in both the van conversion and vanlife categories. Each card features an article thumbnail, snippet, and a link to the full text. Finally, there is a mailing list subscription box that is linked to [Mail Chimp](https://mailchimp.com/).
...
- [Bootstrap](https://getbootstrap.com/docs/5.0/getting-started/introduction/) - This project uses Bootstrap v5.0 for responsive navigation, grid layout, form creation and validation.
...
In order to add files to the repository follow these steps:
- In the command line type 'git add' followed by the pathway to the file e.g index.html or assets/css/style.css.
- Commit using 'git commmit -m "Insert your commit message here". Your commit messages should clearly identify any changes that have been made.
- Use 'git push' to push your changes to the remote repositiory. 

Shortcut: To add all files to your commit use 'git add .' 

### **Local Deployment:**
To depoy the site locally follow these steps:
- In the command line type 'python3 -m http.server'
- Select 'Open Browser' from the pop up window.
- Should the page not load correctly, refresh the page.

### **Deployment - GitHub Pages:**
This site was deployed using GitHub Pages. 

To deploy, the following steps should be taken:
...
### **Individuals:**
- Brian Macharia - Code Institute Mentor. Guidance throughout the project.
